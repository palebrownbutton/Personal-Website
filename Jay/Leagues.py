...
def premier_table():
    ...
    table = [f"{team['position']}. {team['team']['name']} - {team['points']} points" for team in standings]
    return table
...
def champions_table():
    ...
    return [f"{i+1}. {team} - {stats['points']} points" for i, (team, stats) in enumerate(sorted_teams)]
